    ...
    public static class RestauranteAD
    {
        ...
        public static Restaurante[] ListarRestaurante()
        {
            try
            {
                ...
                restaurante[2] = new Restaurante(3, "Restaurante La cocina", "100 norte", true, "24866587");
                restaurante[3] = new Restaurante(4, "Restaurante mi cuñado", "200 sur", true, "57985321");
                return restaurante;
